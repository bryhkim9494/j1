...
public class BoardRepositoryTests {
    ...
    public void testRead() {
        Long bno = 1L;
        Optional<Board> result = boardRepository.findById(1L);// findById는 즉시 로딩 / 무조건 findById만 사용
        log.info("--------------------------------------------------------------");
    ...
    public void testQuery2() {
        Pageable pageable = PageRequest.of(0, 10, Sort.by("bno").descending()); // bno는컬럼명이아니라 프로퍼티명임
